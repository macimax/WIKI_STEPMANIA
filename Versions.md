...
* 3.9 Plus: A fork created as an alternative to StepMania 4 during its development, which focused on backporting features from "3.95" and the StepMania 4 alphas, as well as other additional features, to the existing StepMania 3.9 version.